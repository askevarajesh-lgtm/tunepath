...
const Sidebar = ({ collapsed, setCollapsed }) => {
    ...
    const menuItems = useMemo(() => [
        ...
        },
        {
            ...
            children: [
                ...(role === 'commander_admin' ? [] : [
                    { key: '/workspace/projects', icon: getIcon(Target), label: 'Projects' },
                ]),
                { key: '/workspace/tasks', icon: getIcon(CheckSquare), label: 'Tasks' },
                { key: '/workspace/tasks/analytics', icon: getIcon(BarChart2), label: 'Task Analytics' },
                { key: '/workspace/tasks/coordinator', icon: getIcon(Users), label: 'Coordinator Tasks' },
            ]
        },
        {
            key: 'intelligence',
            ...
            children: [
                ...
                { key: '/intelligence/claude', icon: getIcon(Sparkles), label: 'Claude Chat' },
