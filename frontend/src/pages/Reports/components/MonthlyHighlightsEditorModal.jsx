    ...
    const handleSave = async (status = 'Draft') => {
        try {
            ...
            const notesText = deliverablesList.length > 0
                ? deliverablesList.map(d => `${d.name} — Total: ${d.total || 0}, Completed: ${d.completed || 0}, Pending: ${d.pending || 0}, Remaining: ${d.remaining ?? Math.max(0, (d.total || 0) - (d.completed || 0) - (d.pending || 0))}`).join('; ')
                ...
                <Form form={form} layout="vertical">
                    ...
                    >
                        ...
                        <Form.Item name="brandCommNotes" label="Summary Notes (Optional)">
                            <Input placeholder="e.g., Posters — Total: 10, Completed: 8, Remaining: 2" />
                        </Form.Item>
                    </Card>
