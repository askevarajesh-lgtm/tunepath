...
const reportScheduleSchema = new mongoose.Schema({
  ...
  template: { type: String, required: true, enum: ['Highlights of the Month', 'Keyword Ranking Overview', 'Keyword Ranking Details', 'Meta Insights – Facebook', 'Meta Insights – Instagram', 'Meta Campaign Insights – Lead Campaign', 'Monthly Performance Report', 'SEO Ranking Report', 'Paid Media Report', 'Executive Summary'] },
